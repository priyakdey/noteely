...
description = "Backend service for noteely application"
...
tasks.withType<Test> {
    ...
    addTestListener(object : TestListener {
        ...
        // TODO: Log stats post all test run - custom plugin/ global state?
        private fun logStats(testName: String) {
